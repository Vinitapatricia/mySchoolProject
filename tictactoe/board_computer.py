...
class BoardComputer(tk.Frame):
	...
	def create_info(self):
		...
		self.info_frame1 = tk.Label(self.info_frame, bg = "#3589ad", fg = "white", text = "Player 1 : X",font = ("Comic Sans MS", 12), image = self.virtual_image, compound = "c", width = 95, height = 25)
		self.info_frame1.pack(side = "left")

		self.info_frame2 = tk.Label(self.info_frame, bg = "#3589ad", fg = "white", text = "Player 2 : O",font = ("Comic Sans MS", 12), image = self.virtual_image, compound = "c", width = 95, height = 25)
		self.info_frame2.pack(side = "right")
	...
	def create_button_board(self):
		...
		for i in range(nRow):
			...
			for j in range(nColumn):
				button = tk.Button(self.frame_rows[i], bg = "white", height = button_height, width = button_width,  image = self.init_img_btn ,command = lambda x = i, y = j:self.game.is_button_board_with_computer_clicked(x,y))
